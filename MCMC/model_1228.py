...
def train(model_dict, data_dict, epochs, save_model_path, batch_size=BATCH_SIZE, period=10, choice_idx=None, name=None, auto_stop_n=None,):
    ...
    for i in range(epochs):
        ...
        exp.save(f'{save_model_path}.h5')  # add save .h5 
