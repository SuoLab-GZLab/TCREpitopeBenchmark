...
def get_model(dataset,models_path):
    if dataset == 'vdjdb':
        version = '1veajht'
    if dataset == 'mcpas':
        version = '1meajht'
    ...
    args_path = os.path.join(models_path, 'meta_tags.csv')
...
def Original_model_prediction(dataset, test_file,models_path,result_path):
    model, train_file = get_model(dataset,models_path)
...
models_path="../Original_model/ERGOII_vdj"
result_path="../result_path/Original_model_prediction"
Original_model_prediction(name,testfile_path,result_path)


name='mcpas'
testfile_path="../data/test.csv"
models_path="../Original_model/ERGOII_mc"
result_path="../result_path/Original_model_prediction"
Original_model_prediction(name,testfile_path,result_path)
