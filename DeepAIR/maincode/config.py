...
DeepAIR_BRP_saved_model_dict['GILGFVFTL'] = os.path.join(MODEL_SAVE_PATH, 'BRP/A0201_GILGFVFTL_Flu-MP_Influenza_binder_model')
...
DeepAIR_BRP_saved_model_dict['GLCTLVAML'] = os.path.join(MODEL_SAVE_PATH, 'BRP/A0201_GLCTLVAML_BMLF1_EBV_binder_model')
