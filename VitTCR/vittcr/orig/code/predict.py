...
parser.add_argument("-e", "--epoch", default=100, help="Specify epochs used in model training")
    ...
    for repeat in range(args.repeat):
        ...
        if 1:
            ...
            model = TcrPepTransform_single(input_height=20, 
                                            ...
                                            drop_path_rate=0, 
                                            act_layer=nn.GELU)
            params = "./model/model_fold{}/{}_epochs.pt".format(fold,args.epoch)
