...
parser.add_argument("-f", "--fold", default=5, type=int, help="Specify cv fold")
parser.add_argument("-ip", "--inpath", default="./data", help="Specify input path")
...
if __name__ =="__main__":
    ...
    for repeat in range(args.repeat): 
        ...
        print('fold',fold)
        if 1:
            trainfile = "{}/1_1_{}train.pickle".format(args.inpath, fold)
            validfile = "{}/1_1_{}test.pickle".format(args.inpath, fold)
            
            resultpath1 = "./results/Train_model_lr{}_fold{}.tsv".format(args.learningrate, fold)
            resultpath2 = "./results/Test_model_lr{}_fold{}.tsv".format(args.learningrate, fold)
        
            modelpath = './model/model_fold{}'.format(fold)
            # metricpath = './results/metrics_repeat{}'.format(repeat)
